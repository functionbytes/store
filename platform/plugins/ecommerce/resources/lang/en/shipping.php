...
return [
    ...
    'confirm' => 'Confirm',
    'save' => 'Save',
    'shipping_rule_name_helper' => 'Enter a descriptive name for this shipping rule (e.g., "Express Delivery", "City Center Delivery")',
    'shipping_fee_helper' => 'Base shipping fee for this rule. Additional city-specific fees can be configured below.',
    'location_based_shipping' => 'Location-Based Shipping',
    'location_based_shipping_description' => 'This rule supports city-specific pricing. Configure different rates for specific cities using the options below.',
    'final_price' => 'Final price',
    'city_specific_rates' => 'City-Specific Shipping Rates',
    'city_specific_rates_description' => 'Configure different shipping rates for specific cities within this region.',
    'add_city_rate' => 'Add City Rate',
